...
const Feature = () => {
    return (
        <section className='grid md:grid-cols-3 gap-5 max-w-[1200px] mx-auto mt-[140px] py-5'>
            <div className='w-[95%] mx-auto padding-7 border-2 rounded-2xl bg-slate-300 flex justify-center items-center flex-col min-w-[100px]'>
            ...
            <div className='w-[95%] mx-auto padding-7 rounded  flex justify-center items-center flex-col min-w-[100px] gap-5'>
                <div className='rounded-2xl py-5 flex justify-center items-center flex-col bg-slate-300 w-full'>
                    <p className='bg-white w-10 h-10 rounded-full flex justify-center items-center'>
